...
[^quarto-book]: In fact, this [entire book](https://github.com/mjfrigaard/linux-cb/tree/main) was written using Quarto documents.
...
1. The current working directory is `~/projects/books/linux-cb/` (as indicated by the Terminal prompt):

![`linux-cb/` directory](img/pwd-local-01.png){width='100%'}
