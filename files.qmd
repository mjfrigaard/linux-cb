...
We'll cover this output more in the @sec-file-permissions section below, but here is a quick summary: 
...
## [Permissions and Ownership]{style="font-size: 1.05em; font-weight: bold;"} {#sec-file-permissions}
