...
`sort -u data/roxanne` sorts the lines in `data/roxanne`, removing duplicate lines.[^roxanne]

[^roxanne]: `data/roxanne` contains the lyrics to the 1978 song [Roxanne by The Police](https://en.wikipedia.org/wiki/Roxanne_(The_Police_song)). 
