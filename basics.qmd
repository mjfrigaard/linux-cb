...
This section covers commands that will help navigate folders (or directories), manipulate and manage files, check system processes, and use or create variables. 
...
[System](sys.qmd) touches on system monitoring.
