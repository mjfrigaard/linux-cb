...
`source/file.txt` and `destination/file.txt` are arguments representing the source and destination locations to move with <code>@sec-mv</code>, respectively.
...
To copy the contents of the new `myfile2.txt` to `'my file 3.txt`, you would use:
