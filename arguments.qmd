...
## [Anatomy]{style="font-size: 1.15em; font-weight: bold;"}
...
## [Argument Types]{style="font-size: 1.15em; font-weight: bold;"} 
...
`tmp/myfile.txt` is the first argument (indicating the file to copy from), and `myfile.txt` is the second argument (indicating where to copy the file to). 
